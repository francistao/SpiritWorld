 ...
 */
public class Server_UploadIcon implements IServer {
	final String SERVER_SUBMIT_VALUE = "uploadIcon";
	
	public Result_SuccessOrFail getServer(String userName, String password, String filePath) {
		...
		String reply = "";
		try {
			reply = new zhp.java.netio.upload.Utils_Post()
			.post("http://1.iyalee.sinaapp.com/UploadIcon.php", params, filePath, new Utils_General().toAscii(userName) + ".jpg");
		} catch (Exception e) {
			e.printStackTrace();
