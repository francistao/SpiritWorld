 ...
 *
 */
public class Server_GetUserProfile implements IServer {
	final String SERVER_SUBMIT_VALUE = "getProfile";
	final String SERVER_URL = "http://1.iyalee.sinaapp.com/arworld/GetUserProfile.php";
	...
	public Result_String getServer(String userName) {
		...
		try {
			...
			android.util.Log.i("郑海鹏", "Server_GetUserProfile#getServer(): " + reply);
		} catch (Exception e) {
			e.printStackTrace();
			return new Result_String(null);
		}
