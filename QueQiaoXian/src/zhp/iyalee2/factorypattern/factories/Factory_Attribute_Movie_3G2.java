 ...
 * @since 2015年7月3日
 */
public class Factory_Attribute_Movie_3G2 implements IFactory_Attribute_Movie {

	@Override
	public Attribute_Movie createAttribute(){
		final String trackingConfigFilePath = "movies/TrackingData_MarkerlessFast.xml";
		ArrayList<GeometryMovieData> geometryDatas = new ArrayList<GeometryMovieData>();
		
		// 在这里添加新的模型，注意：如果要添加模型的话，记得在跟踪配置文件里添加响应项
		geometryDatas.add(new GeometryMovieData(1, "movies/mj.3gp", 3, new Rotation(0, 0, (float) -Math.PI / 2), null, false));
